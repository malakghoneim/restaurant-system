...
namespace first {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class customersDataTable : global::System.Data.TypedTableBase<customersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public customersRow AddcustomersRow(string name, int age, int id) {
...
namespace first.DataSet1TableAdapters {
    ...
    public partial class customersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[customers] WHERE (([name] = @Original_name) AND ([age] = @Orig" +
                "inal_age) AND ([id] = @Original_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[customers] ([name], [age], [id]) VALUES (@name, @age, @id);\r\nS" +
                "ELECT name, age, id FROM customers WHERE (name = @name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[customers] SET [name] = @name, [age] = @age, [id] = @id WHERE (([na" +
                "me] = @Original_name) AND ([age] = @Original_age) AND ([id] = @Original_id));\r\nS" +
                "ELECT name, age, id FROM customers WHERE (name = @name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::first.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, age, id FROM dbo.customers";
        ...
        public virtual int Delete(string Original_name, int Original_age, int Original_id) {
        ...
        public virtual int Insert(string name, int age, int id) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, int age, int id, string Original_name, int Original_age, int Original_id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int age, int id, string Original_name, int Original_age, int Original_id) {
            return this.Update(Original_name, age, id, Original_name, Original_age, Original_id);
        }
    }
